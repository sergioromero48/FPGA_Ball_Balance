...
HD_PWD='C:/Users/sergi/DSD_FINAL_Project/DSD_FINAL_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BBa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BBa.tcl
