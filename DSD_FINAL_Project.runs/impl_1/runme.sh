...
HD_PWD='C:/Users/sergi/DSD_FINAL_Project/DSD_FINAL_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BBa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BBa.tcl -notrace
